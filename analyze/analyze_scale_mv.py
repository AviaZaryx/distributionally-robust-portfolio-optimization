...
def run_mv_scaling(data, solver_name="Classic MV"):
    ...
    for p in range(1, N_PARTS + 1):
        ...
        # Reset all 4 timers for this specific scale step
        reset_timers()
        ...
        print(f"Executing Run {p}/{N_PARTS} with {num_to_use} assets...")
        ...
        # Record the 4-component tuple: (Data, Setup, Math, Post)
        res_tuple = (
...
if __name__ == "__main__":
    ...
    if not data.empty:
        ...
        print("Data could not be loaded. Check CSV_FILE path and date range.")